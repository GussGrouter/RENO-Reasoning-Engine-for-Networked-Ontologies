# systems-performance-case-study-software-change-1-11-2 (chunk 000001)

# Systems Performance — case study: software change (1.11.2) (PDF pages 56–64)

- Source: raw/code/pdf/Systems.Performance.Enterprise.and.the.Cloud.pdf
- Extraction base: processed/code/systems-performance-case-studies-p56-58.md + p58-64.md
- Slice: from `1.11.2 Software Change` up to before `1.11.3 More Reading`
