# A Philosophy of Software Design — abstraction principles (PDF pages 35–39)

- Source: raw/code/pdf/a-philosophy-of-software-design.pdf
- Extraction: pdftotext -f 35 -l 39 -layout
- Slice: from `4.3 Abstractions` up to (excluding) `4.4 Deep modules`
---
