# systems-performance-more-reading-and-references-1-11-3-1-12 (chunk 000001)

# Systems Performance — more reading + references (1.11.3–1.12) (PDF pages 55–72)

- Source: raw/code/pdf/Systems.Performance.Enterprise.and.the.Cloud.pdf
- Extraction base: processed/code/systems-performance-intro-1-7-2-to-1-8-p55-72.md
- Slice: from `1.11.3 More Reading` through end of Chapter 1 references
