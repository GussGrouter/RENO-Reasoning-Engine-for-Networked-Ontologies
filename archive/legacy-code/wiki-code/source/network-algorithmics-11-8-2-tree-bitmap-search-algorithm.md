# Network Algorithmics — Tree bitmap search algorithm (11.8.2)
...
- Batch scope: Section 11.8.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-8-2-tree-bitmap-search-algorithm.md`
- Chunks:
  - `network-algorithmics-11-8-2-tree-bitmap-search-algorithm-chunk-000001.md`
