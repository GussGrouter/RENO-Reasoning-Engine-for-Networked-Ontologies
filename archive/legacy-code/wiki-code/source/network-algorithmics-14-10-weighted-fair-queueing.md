# Network Algorithmics — Weighted fair queueing (14.10)
...
- Batch scope: Section 14.10 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-14-10-weighted-fair-queueing.md`
- Chunks:
  - `network-algorithmics-14-10-weighted-fair-queueing-chunk-000001.md`
  - `network-algorithmics-14-10-weighted-fair-queueing-chunk-000002.md`
