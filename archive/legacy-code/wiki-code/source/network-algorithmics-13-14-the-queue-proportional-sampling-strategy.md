# Network Algorithmics — The queue-proportional sampling strategy (13.14)
...
- Batch scope: Section 13.14 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-14-the-queue-proportional-sampling-strategy.md`
- Chunks:
  - `network-algorithmics-13-14-the-queue-proportional-sampling-strategy-chunk-000001.md`
