# Network Algorithmics — Using short links for higher-speed fabrics (13.19.2)
...
- Batch scope: Section 13.19.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-19-2-using-short-links-for-higher-speed-fabrics.md`
- Chunks:
  - `network-algorithmics-13-19-2-using-short-links-for-higher-speed-fabrics-chunk-000001.md`
