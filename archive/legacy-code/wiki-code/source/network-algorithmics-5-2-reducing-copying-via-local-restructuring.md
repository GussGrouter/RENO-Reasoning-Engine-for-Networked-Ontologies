# Network Algorithmics — Reducing copying via local restructuring (5.2)
...
- Batch scope: Section 5.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-5-2-reducing-copying-via-local-restructuring.md`
- Chunks:
  - `network-algorithmics-5-2-reducing-copying-via-local-restructuring-chunk-000001.md`
