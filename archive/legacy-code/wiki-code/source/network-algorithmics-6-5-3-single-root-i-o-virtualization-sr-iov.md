# Network Algorithmics — Single Root I/O Virtualization (SR-IOV) (6.5.3)
...
- Batch scope: Section 6.5.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-6-5-3-single-root-i-o-virtualization-sr-iov.md`
- Chunks:
  - `network-algorithmics-6-5-3-single-root-i-o-virtualization-sr-iov-chunk-000001.md`
