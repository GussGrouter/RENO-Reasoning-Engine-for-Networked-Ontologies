# Network Algorithmics — PopTrie: an alternate bitmap algorithm (11.8.3)
...
- Batch scope: Section 11.8.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-8-3-poptrie-an-alternate-bitmap-algorithm.md`
- Chunks:
  - `network-algorithmics-11-8-3-poptrie-an-alternate-bitmap-algorithm-chunk-000001.md`
