# Network Algorithmics — Content-addressable memories (12.4.6)
...
- Batch scope: Section 12.4.6 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-12-4-6-content-addressable-memories.md`
- Chunks:
  - `network-algorithmics-12-4-6-content-addressable-memories-chunk-000001.md`
