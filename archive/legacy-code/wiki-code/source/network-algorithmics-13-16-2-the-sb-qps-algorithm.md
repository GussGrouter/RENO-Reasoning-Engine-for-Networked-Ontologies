# Network Algorithmics — The SB-QPS algorithm (13.16.2)
...
- Batch scope: Section 13.16.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-16-2-the-sb-qps-algorithm.md`
- Chunks:
  - `network-algorithmics-13-16-2-the-sb-qps-algorithm-chunk-000001.md`
