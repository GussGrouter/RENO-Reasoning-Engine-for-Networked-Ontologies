# Network Algorithmics — Approximate fair dropping (14.3)
...
- Batch scope: Section 14.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-14-3-approximate-fair-dropping.md`
- Chunks:
  - `network-algorithmics-14-3-approximate-fair-dropping-chunk-000001.md`
