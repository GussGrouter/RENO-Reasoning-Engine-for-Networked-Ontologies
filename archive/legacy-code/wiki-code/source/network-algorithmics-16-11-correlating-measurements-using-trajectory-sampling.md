# Network Algorithmics — Correlating measurements using trajectory sampling (16.11)
...
- Batch scope: Section 16.11 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-16-11-correlating-measurements-using-trajectory-sampling.md`
- Chunks:
  - `network-algorithmics-16-11-correlating-measurements-using-trajectory-sampling-chunk-000001.md`
