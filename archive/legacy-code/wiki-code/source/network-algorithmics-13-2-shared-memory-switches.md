# Network Algorithmics — Shared-memory switches (13.2)
...
- Batch scope: Section 13.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-2-shared-memory-switches.md`
- Chunks:
  - `network-algorithmics-13-2-shared-memory-switches-chunk-000001.md`
