# Network Algorithmics — Identifying a resource hog (4.10)
...
- Batch scope: Section 4.10 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-4-10-identifying-a-resource-hog.md`
- Chunks:
  - `network-algorithmics-4-10-identifying-a-resource-hog-chunk-000001.md`
  - `network-algorithmics-4-10-identifying-a-resource-hog-chunk-000002.md`
