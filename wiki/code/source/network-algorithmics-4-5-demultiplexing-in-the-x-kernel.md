# Network Algorithmics — Demultiplexing in the x-kernel (4.5)
...
- Batch scope: Section 4.5 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-4-5-demultiplexing-in-the-x-kernel.md`
- Chunks:
  - `network-algorithmics-4-5-demultiplexing-in-the-x-kernel-chunk-000001.md`
  - `network-algorithmics-4-5-demultiplexing-in-the-x-kernel-chunk-000002.md`
