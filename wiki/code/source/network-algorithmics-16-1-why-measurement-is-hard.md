# Network Algorithmics — Why measurement is hard (16.1)
...
- Batch scope: Section 16.1 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-16-1-why-measurement-is-hard.md`
- Chunks:
  - `network-algorithmics-16-1-why-measurement-is-hard-chunk-000001.md`
