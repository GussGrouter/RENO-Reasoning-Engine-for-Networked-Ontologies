# Network Algorithmics — The SW-QPS algorithm (13.16.3)
...
- Batch scope: Section 13.16.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-16-3-the-sw-qps-algorithm.md`
- Chunks:
  - `network-algorithmics-13-16-3-the-sw-qps-algorithm-chunk-000001.md`
