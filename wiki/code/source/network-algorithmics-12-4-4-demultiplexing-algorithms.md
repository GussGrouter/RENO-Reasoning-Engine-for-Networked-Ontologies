# Network Algorithmics — Demultiplexing algorithms (12.4.4)
...
- Batch scope: Section 12.4.4 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-12-4-4-demultiplexing-algorithms.md`
- Chunks:
  - `network-algorithmics-12-4-4-demultiplexing-algorithms-chunk-000001.md`
