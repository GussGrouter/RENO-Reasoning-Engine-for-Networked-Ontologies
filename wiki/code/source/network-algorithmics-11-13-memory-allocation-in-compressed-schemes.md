# Network Algorithmics — Memory allocation in compressed schemes (11.13)
...
- Batch scope: Section 11.13 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-13-memory-allocation-in-compressed-schemes.md`
- Chunks:
  - `network-algorithmics-11-13-memory-allocation-in-compressed-schemes-chunk-000001.md`
