# Network Algorithmics — Packet filtering in routers (4.7)
...
- Batch scope: Section 4.7 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-4-7-packet-filtering-in-routers.md`
- Chunks:
  - `network-algorithmics-4-7-packet-filtering-in-routers-chunk-000001.md`
  - `network-algorithmics-4-7-packet-filtering-in-routers-chunk-000002.md`
