# Network Algorithmics — IP Lookups in the P4 Model (11.15.2)
...
- Batch scope: Section 11.15.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-15-2-ip-lookups-in-the-p4-model.md`
- Chunks:
  - `network-algorithmics-11-15-2-ip-lookups-in-the-p4-model-chunk-000001.md`
  - `network-algorithmics-11-15-2-ip-lookups-in-the-p4-model-chunk-000002.md`
