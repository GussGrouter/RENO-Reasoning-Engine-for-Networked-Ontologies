# Network Algorithmics — Generalized processor sharing (14.9)
...
- Batch scope: Section 14.9 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-14-9-generalized-processor-sharing.md`
- Chunks:
  - `network-algorithmics-14-9-generalized-processor-sharing-chunk-000001.md`
