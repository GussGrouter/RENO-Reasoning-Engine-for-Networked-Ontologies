# Network Algorithmics — Why variable-length prefixes? (11.1.2)
...
- Batch scope: Section 11.1.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-1-2-why-variable-length-prefixes.md`
- Chunks:
  - `network-algorithmics-11-1-2-why-variable-length-prefixes-chunk-000001.md`
