# Network Algorithmics — Avoiding copying using remote DMA (5.3)
...
- Batch scope: Section 5.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-5-3-avoiding-copying-using-remote-dma.md`
- Chunks:
  - `network-algorithmics-5-3-avoiding-copying-using-remote-dma-chunk-000001.md`
