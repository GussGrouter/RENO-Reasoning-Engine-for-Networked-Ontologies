# Network Algorithmics — Are zero copies used today? (5.2.5)
...
- Batch scope: Section 5.2.5 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-5-2-5-are-zero-copies-used-today.md`
- Chunks:
  - `network-algorithmics-5-2-5-are-zero-copies-used-today-chunk-000001.md`
