# Network Algorithmics — The problem: network bottlenecks (1.1)
...
- Batch scope: Section 1.1 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-1-1-the-problem-network-bottlenecks.md`
- Chunks:
  - `network-algorithmics-1-1-the-problem-network-bottlenecks-chunk-000001.md`
