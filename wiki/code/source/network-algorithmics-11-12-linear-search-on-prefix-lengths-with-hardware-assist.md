# Network Algorithmics — Linear search on prefix lengths with hardware assist (11.12)
...
- Batch scope: Section 11.12 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-12-linear-search-on-prefix-lengths-with-hardware-assist.md`
- Chunks:
  - `network-algorithmics-11-12-linear-search-on-prefix-lengths-with-hardware-assist-chunk-000001.md`
