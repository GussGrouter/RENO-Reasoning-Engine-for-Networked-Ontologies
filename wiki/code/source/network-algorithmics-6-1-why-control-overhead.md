# Network Algorithmics — Why control overhead? (6.1)
...
- Batch scope: Section 6.1 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-6-1-why-control-overhead.md`
- Chunks:
  - `network-algorithmics-6-1-why-control-overhead-chunk-000001.md`
  - `network-algorithmics-6-1-why-control-overhead-chunk-000002.md`
