# Network Algorithmics — CMU/Stanford packet filter: pioneering packet filters (8.3)
...
- Batch scope: Section 8.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-8-3-cmu-stanford-packet-filter-pioneering-packet-filters.md`
- Chunks:
  - `network-algorithmics-8-3-cmu-stanford-packet-filter-pioneering-packet-filters-chunk-000001.md`
