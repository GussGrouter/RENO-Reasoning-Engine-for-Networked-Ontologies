# Network Algorithmics — Reducing memory using backtracking (12.5.2)
...
- Batch scope: Section 12.5.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-12-5-2-reducing-memory-using-backtracking.md`
- Chunks:
  - `network-algorithmics-12-5-2-reducing-memory-using-backtracking-chunk-000001.md`
