# Network Algorithmics — Using hardware parallelism (10.3.2)
...
- Batch scope: Section 10.3.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-10-3-2-using-hardware-parallelism.md`
- Chunks:
  - `network-algorithmics-10-3-2-using-hardware-parallelism-chunk-000001.md`
  - `network-algorithmics-10-3-2-using-hardware-parallelism-chunk-000002.md`
