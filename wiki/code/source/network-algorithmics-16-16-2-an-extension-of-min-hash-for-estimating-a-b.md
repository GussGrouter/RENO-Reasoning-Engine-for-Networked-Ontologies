# Network Algorithmics — An extension of min-hash for estimating |A                     B| (16.16.2)
...
- Batch scope: Section 16.16.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-16-16-2-an-extension-of-min-hash-for-estimating-a-b.md`
- Chunks:
  - `network-algorithmics-16-16-2-an-extension-of-min-hash-for-estimating-a-b-chunk-000001.md`
