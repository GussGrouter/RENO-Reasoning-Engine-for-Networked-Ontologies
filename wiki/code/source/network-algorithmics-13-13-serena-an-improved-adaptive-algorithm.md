# Network Algorithmics — SERENA: an improved adaptive algorithm (13.13)
...
- Batch scope: Section 13.13 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-13-13-serena-an-improved-adaptive-algorithm.md`
- Chunks:
  - `network-algorithmics-13-13-serena-an-improved-adaptive-algorithm-chunk-000001.md`
