# Network Algorithmics — Avoiding file system copies via I/O splicing (5.4.3)
...
- Batch scope: Section 5.4.3 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-5-4-3-avoiding-file-system-copies-via-i-o-splicing.md`
- Chunks:
  - `network-algorithmics-5-4-3-avoiding-file-system-copies-via-i-o-splicing-chunk-000001.md`
