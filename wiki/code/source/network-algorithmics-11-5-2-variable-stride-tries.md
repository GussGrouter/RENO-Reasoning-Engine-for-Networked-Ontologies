# Network Algorithmics — Variable-stride tries (11.5.2)
...
- Batch scope: Section 11.5.2 (full-text layout section sweep v4)

## Processed artifacts

- Converted slice: `processed/code/network-algorithmics-11-5-2-variable-stride-tries.md`
- Chunks:
  - `network-algorithmics-11-5-2-variable-stride-tries-chunk-000001.md`
  - `network-algorithmics-11-5-2-variable-stride-tries-chunk-000002.md`
