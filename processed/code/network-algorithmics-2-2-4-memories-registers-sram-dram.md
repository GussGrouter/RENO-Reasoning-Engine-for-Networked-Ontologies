# Network Algorithmics — memories (2.2.4) intro: registers, SRAM, DRAM

- Source: raw/code/pdf/Network.Algorithmics.pdf
- Extraction: pdftotext -f 52 -l 56 -layout
- Slice: from `2.2.4 Memories` up to (excluding) `FIGURE 2.5`
