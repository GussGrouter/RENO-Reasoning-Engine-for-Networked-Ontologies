# systems-performance-case-study-slow-disks-1-11-1 (chunk 000001)

# Systems Performance — case study: slow disks (1.11.1) (PDF pages 55–60)

- Source: raw/code/pdf/Systems.Performance.Enterprise.and.the.Cloud.pdf
- Extraction base: processed/code/systems-performance-case-studies-p55-60.md
- Slice: from `1.11.1 Slow Disks` up to before `1.11.2 Software Change`
