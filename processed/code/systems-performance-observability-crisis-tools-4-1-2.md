# Systems Performance — Section 4.1.2 crisis tools (crisis-tools-4-1-2)

- Source: raw/code/pdf/Systems.Performance.Enterprise.and.the.Cloud.pdf
- Extraction bases: processed/code/systems-performance-ch3-background-p118-170.txt + processed/code/systems-performance-ch4-scout-p171-220.txt
- PDF pages (approx): 118–220
